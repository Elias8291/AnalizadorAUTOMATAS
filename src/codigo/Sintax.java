...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Jul 21 11:50:19 CST 2023
  */
public class Sintax extends java_cup.runtime.lr_parser {
  ...
  public int error_sym() {return 1;}
    ...
    public void syntax_error(Symbol s){
        this.s = s;
        this.error = "Syntax error at line " + (s.right + 1) + ", column " + (s.left + 1) + ".";
...
class CUP$Sintax$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Sintax$do_action(
    ...
    if (value.length() == 3 && value.startsWith("'") && value.endsWith("'")) {
        ...
        codigoIntermedio.crearEntrada(new Quadruple("SystemOutPrintln", i1.toString(), "", ""));
        ...
        codigoIntermedio.crearEntrada(new Quadruple("SystemOutPrintln", s.toString(), "", ""));
